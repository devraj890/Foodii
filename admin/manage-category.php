...
<div class="main-content" id="3">
    <div class="wrapper">
        ...
        <!-- Button to Add Admin -->
        <a href="<?php echo $SITEURL; ?>admin/add-category.php" class="btn btn-outline-secondary m-1">Add Category</a>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo $SITEURL; ?>admin/update-category.php?id=<?php echo $id; ?>"
                        class="btn btn-outline-secondary m-1">Update Category</a>
                    <a href="<?php echo $SITEURL; ?>admin/delete-category.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>"
                        class="btn btn-outline-secondary m-1">Delete Category</a>
                </td>
            </tr>
